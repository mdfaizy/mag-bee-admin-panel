...
const TextArea = forwardRef<HTMLTextAreaElement, TextareaProps>(
  (
    ...
    if (disabled) {
      ...
      textareaClasses +=
        " bg-transparent border-red-500 focus:border-red-500 focus:ring-2 focus:ring-red-500/20 dark:border-red-700";
    } else {
      textareaClasses +=
        " bg-transparent border-gray-300 focus:border-brand-300 focus:ring-2 focus:ring-brand-500/20 dark:border-gray-700";
    }
