                    ...
                    (levelOptions, levelIndex) => (
                      ...
                      >
                        ...
                        <Select
                          ...
                          placeholder={`Select Child Level ${levelIndex + 1
                            }`}
                          value={
                            selectedNestedIds[
                            levelIndex
          ...
          <div className="mt-6 border border-gray-200 rounded-lg">
            <div className="bg-gray-100 p-3 border-b border-gray-200 flex justify-between items-center">
              ...
              <button
                ...
                className={`text-sm font-medium flex items-center ${watchHasVariants ? "text-red-600 hover:text-red-800" : "text-blue-600 hover:text-blue-800"
                  }`}
              >
                {watchHasVariants ? (
                  <>
